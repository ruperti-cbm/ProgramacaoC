// Desafio Super Trunfo - Países // Tema 1 - Cadastro das Cartas //Objetivo: No nível Novato, você deve criar as cartas representando as cidades, utilizando scanf para a entrada de dados e printf para exibir as informações
...
//Calculo de Densidade Populacional do Sergipe
densidade1 = populacao1 / area1;

//Calulo de PIB per capita do Sergipe
pibpercapita1 = pib1 / populacao1;

    //Calculo de Densidade Populacional da Bahia
densidade2 = populacao2 / area2;
    //Calculo de PIB per capita da Bahia
